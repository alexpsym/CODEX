...
export TRADING_JOURNAL_BYBIT_DEMO_BALANCE_ANCHOR_ENABLED="1"
...
export MASTER_ENV_PROTECTED_KEYS="APP_PROFILE,TRADING_JOURNAL_ONLY,TRADING_JOURNAL_SOURCE,TRADING_JOURNAL_ENABLE_LOCAL_IMPORT,TRADING_JOURNAL_BROKER_REFRESH_ENABLED,TRADING_JOURNAL_BYBIT_DEMO_BALANCE_ANCHOR_ENABLED,TRADING_JOURNAL_LOCAL_DIR,DROPBOX_SYNC_ENABLED,LOCAL_STATE_ONLY"
